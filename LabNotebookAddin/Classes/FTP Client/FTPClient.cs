...
namespace FTP
{
	...
	/////// FROM codeplex.com http://ftpclient.codeplex.com/
	...
	public class FTPclient
	{
		...
		#endregion "Upload: File transfer TO ftp server"
		...
		#endregion "Download: File transfer FROM ftp server"
		...
		#endregion "Other functions: Delete rename etc."
		...
		#endregion "private supporting fns"
