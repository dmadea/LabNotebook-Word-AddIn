...
public class ResidualSolventTableModel extends AbstractTableModel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1228075059315365744L;
	...
	public void resetModelData() {
		try {
			for (int i = 0; i < this.getResidualSolventVOList().size(); i++) {
				BatchRegistrationResidualSolvent residualSolventVO = (BatchRegistrationResidualSolvent) this
