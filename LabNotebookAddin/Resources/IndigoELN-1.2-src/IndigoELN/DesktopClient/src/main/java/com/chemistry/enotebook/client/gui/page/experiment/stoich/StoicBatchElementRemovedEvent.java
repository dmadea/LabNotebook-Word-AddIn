...
public class StoicBatchElementRemovedEvent extends EventObject {
	
	private static final long serialVersionUID = 2749333082280768134L;
	
	StoicModelInterface stoicmodel;

	public StoicBatchElementRemovedEvent(Object source, StoicModelInterface stoicI) {
		super(source);
