 ...
 * <P>
 * Sides of the components can be anchored either absolutely (eg, if the right side is anchored absolutely then it will always be a
 * fixed number of pixels from the right side of it's parent container) or relatively (ie, if any side is anchored relatively then
 * it will always occur a fixed fraction of the way along it's parent's side). Or they can be not anchored, at all in which case
 * they will occur at places determined by their component's "bounds" property and the anchoring of the component's other sides.
 */
public class AnchorLayout implements LayoutManager2 {
	int preferredWidth, preferredHeight, minHeight, minWidth;
	int numChildren = -1;
	Map<Component, Object> constraintMap = new HashMap<Component, Object>();
	 ...
	 * (non-Javadoc)
	 * 
	 * @see java.awt.LayoutManager#preferredLayoutSize(java.awt.SampleContainer)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see java.awt.LayoutManager#minimumLayoutSize(java.awt.SampleContainer)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see java.awt.LayoutManager2#maximumLayoutSize(java.awt.SampleContainer)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see java.awt.LayoutManager2#getLayoutAlignmentX(java.awt.SampleContainer)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see java.awt.LayoutManager2#getLayoutAlignmentY(java.awt.SampleContainer)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see java.awt.LayoutManager2#invalidateLayout(java.awt.SampleContainer)
	 */
