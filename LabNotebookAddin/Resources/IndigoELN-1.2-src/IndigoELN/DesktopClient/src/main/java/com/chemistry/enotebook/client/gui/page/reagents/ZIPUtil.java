...
public class ZIPUtil {
	...
	public static void main(String[] args) {
		String testFileName = MasterController.getApplicationDirectory() + File.separator + "myreagents.xml";
		try {
			byte[] original = null;
			java.io.FileInputStream fis = new java.io.FileInputStream(testFileName);
