 ...
 *
 */
public class PCeNRegistration_SummaryTableModel extends PCeNTableModel {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3143525269774567415L;

	/**
	 * 
	 */
	public PCeNRegistration_SummaryTableModel() {
		super();
	}
	 ...
	 * @param connector
	 */
	public PCeNRegistration_SummaryTableModel(PCeNTableModelConnector connector) {
		super(connector);
	}
