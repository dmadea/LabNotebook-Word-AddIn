...
public class MedChemStoic_ProductsTableViewCellRenderer implements TableCellRenderer{
	...
	public MedChemStoic_ProductsTableViewCellRenderer() {
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row,
			int column) {
		MedChemStoic_ProductsTableView ceNStoich_MonomersTableView = (MedChemStoic_ProductsTableView) table;
		MedChemStoic_ProductsTableControllerUtility connector = (MedChemStoic_ProductsTableControllerUtility) ceNStoich_MonomersTableView.getConnector();
