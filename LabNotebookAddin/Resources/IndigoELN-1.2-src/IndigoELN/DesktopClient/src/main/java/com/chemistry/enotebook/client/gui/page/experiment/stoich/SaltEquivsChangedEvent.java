...
public class SaltEquivsChangedEvent extends EventObject {

	private static final long serialVersionUID = -633549821590035528L;

	StoicModelInterface stoicmodel;

	public SaltEquivsChangedEvent(Object source, StoicModelInterface stoicI) {
		super(source);
