...
public class RxnEquivChangedEvent extends EventObject {
	
	private static final long serialVersionUID = 170931840210845852L;
	
	StoicModelInterface stoicmodel;

	public RxnEquivChangedEvent(Object source, StoicModelInterface stoicI) {
		super(source);
