...
public class DateComboBox extends JComboBox {
	...
	private static final long serialVersionUID = -6454050726881417903L;
	...
	// Inner classes are used purely to keep DateComboBox component in one
	// file
	// ////////////////////////////////////////////////////////////
	...
	class MotifDateComboBoxUI extends MotifComboBoxUI {
		...
		private static final long serialVersionUID = 6032168447099390224L;
	...
	class DatePopup implements ComboPopup, MouseMotionListener, MouseListener, KeyListener, PopupMenuListener {
		...
		public void keyReleased(KeyEvent e) {
			if (e.getKeyCode() == KeyEvent.VK_DELETE || e.getKeyCode() == KeyEvent.VK_SPACE) {
		...
		protected void initializePopup() {
			JPanel header = new JPanel(); // used Box, but it wasn't
			// Opaque
