...
public class DensityChangedEvent extends EventObject {

	private static final long serialVersionUID = 3641935132101860617L;
	
	StoicModelInterface stoicmodel;

	public DensityChangedEvent(Object source, StoicModelInterface stoicI) {
		super(source);
