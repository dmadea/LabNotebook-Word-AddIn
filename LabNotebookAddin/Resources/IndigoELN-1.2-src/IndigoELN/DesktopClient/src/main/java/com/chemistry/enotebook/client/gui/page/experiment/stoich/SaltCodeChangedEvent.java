...
public class SaltCodeChangedEvent extends EventObject {

	private static final long serialVersionUID = -5437557876954064374L;
	
	StoicModelInterface stoicmodel;

	public SaltCodeChangedEvent(Object source, StoicModelInterface stoicI) {
		super(source);
