...
class WorkQueue {
	...
	/** Use only to prevent further processing * */
	public synchronized void emptyQueue() {
		work.clear();
	}

	/**
	 * Use to stop a process until all work for a queue is finished.
	 * 
	 * @throws InterruptedException
	 */
	public void signalWhenDone() throws InterruptedException {
		while (!work.isEmpty()) {
			try {
				wait(500);
			} catch (InterruptedException ie) {
