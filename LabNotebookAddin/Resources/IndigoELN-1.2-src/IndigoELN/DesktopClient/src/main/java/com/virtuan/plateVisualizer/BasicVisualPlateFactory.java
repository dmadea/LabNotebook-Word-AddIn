...
/**
 * Title: VisualPlateFactory Description: This class creates specific GUI representations for plates
 * 2003
 */
public class BasicVisualPlateFactory implements IVisualPlateFactory {
	...
	public PlateMood createPlateMood(String moodType, String title) {
		if (moodType.equals(PLATE_TYPE_BLUE_BOX))
	...
	public static PlateMood createBlueBoxPlateMood(int numberOfRows, int numberOfColumns, String title) {
		return new PlateMood(ChartColor.LIGHT_CYAN, title, DEFAULT_ROW_LABEL, DEFAULT_COLUMN_LABEL, numberOfColumns, numberOfRows,
				ChartColor.DARK_CYAN, new BasicStroke(20.0f), PlateMood.WELL_LABEL_FONT_HELVETICA, -4, 1, true,
