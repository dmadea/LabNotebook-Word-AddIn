...
/**
 * Title: WellRenderer Description: This class represents the rendering characteristic for wells 
 */
public class WellRenderer extends AbstractXYItemRenderer implements XYItemRenderer, Cloneable, PublicCloneable, Serializable {
	
	private static final long serialVersionUID = 1207935909585734049L;
	
	private StaticPlateRenderer _plate;
	 ...
	 */
	public WellRenderer(StaticPlateRenderer plate, PlateModel model) {
		super();
		_plate = plate;
		_model = model;
	}
