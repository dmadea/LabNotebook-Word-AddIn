 ...
 *
 */
public class PCeNAmountCellEditor extends PCeNAmountComponent implements TableCellEditor, MouseListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 762791507775162251L;
	private static CeNErrorHandler ceh = CeNErrorHandler.getInstance();
	// This is the component that will handle the editing of the cell value
	protected transient Vector listeners;

	public PCeNAmountCellEditor() {
		super();
		setEditable(true);
	...
	public void setValue(Object value) {
		    // System.out.println("AmountCellEditor.setValue(Object)
	...
	protected void debugState(String source) {
		...
		//if (debug) {
			Amount2 newAmount = (Amount2) getCellEditorValue();
