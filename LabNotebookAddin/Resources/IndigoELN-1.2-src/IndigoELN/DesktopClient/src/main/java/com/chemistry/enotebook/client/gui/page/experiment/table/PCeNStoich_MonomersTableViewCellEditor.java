...
public class PCeNStoich_MonomersTableViewCellEditor extends DefaultCellEditor {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 718316461926813166L;
	...
	public PCeNStoich_MonomersTableViewCellEditor() {
	...
	public Component getTableCellEditorComponent(final JTable table, Object value, boolean isSelected, int row, int column) {
		if (value == null)
		 ...
		 if (value instanceof String) {
			...
			JPanel chkBoxPanel = new JPanel(layout);
	...
	private class StringCellEditor extends DefaultCellEditor {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -1191393920486401553L;
		...
		private StringCellEditor() {
			...
			delegate = new EditorDelegate() {
				 ...
				 * 
				 */
				private static final long serialVersionUID = 9049590316051070706L;
