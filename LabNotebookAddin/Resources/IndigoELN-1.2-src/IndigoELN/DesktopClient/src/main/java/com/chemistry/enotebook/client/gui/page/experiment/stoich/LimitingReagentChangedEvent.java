...
public class LimitingReagentChangedEvent extends EventObject{
	
	private static final long serialVersionUID = 6838681718913907699L;
	
	StoicModelInterface stoicmodel;
	
	public LimitingReagentChangedEvent(Object source,StoicModelInterface stoicI)
	{
		super(source);
