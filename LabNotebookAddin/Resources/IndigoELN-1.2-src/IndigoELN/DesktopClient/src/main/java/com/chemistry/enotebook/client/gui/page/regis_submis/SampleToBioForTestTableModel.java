 ...
 */
public class SampleToBioForTestTableModel extends AbstractTableModel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5106860628931346859L;
	...
	public String getColumnName(int column) {
		switch (column) {
			case 0:
				return SampleToBioForTestTableModel.SCREEN_NAME;
			case 1:
				return SampleToBioForTestTableModel.SCREEN_CODE;
			case 2:
				return SampleToBioForTestTableModel.SITE_AND_RECIPIENT_NAME;
			case 3:
				return SampleToBioForTestTableModel.MIN_AMOUNT_NEEDED;
			case 4:
				return SampleToBioForTestTableModel.DELIVERY_CONTAINER_TYPE;
		}
		return "";
	}
	...
	public void resetModelData(ArrayList selfList) {
		for (int i = 0; i < selfList.size(); i++) {
			BatchSubmissionToBiologistTest batchSubmissionToBiologistTest = (BatchSubmissionToBiologistTest) selfList.get(i);
