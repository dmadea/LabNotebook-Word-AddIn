...
public class MolecularWeightChangedEvent extends EventObject {
	
	private static final long serialVersionUID = 4986488467137719631L;
	
	StoicModelInterface stoicmodel;

	public MolecularWeightChangedEvent(Object source, StoicModelInterface stoicI) {
		super(source);
