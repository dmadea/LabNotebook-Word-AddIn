 ...
 *
 */
public class PCeNAmountCellRenderer extends PCeNAmountComponent implements TableCellRenderer {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1495006948109518789L;

	/*
	 * The default renderer for a Cell in a JTable is a JLabel. The trick here is to ...
	 */
	public PCeNAmountCellRenderer() {
		super();
	}
