...
public class CustomTextField extends JTextField {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8461458716131180948L;
...
* @param max
*/
    public CustomTextField(Number min, Number max) {
        this(min, max, min);
    }
...
* @param rightJustify
*/
    public CustomTextField(Number min, Number max, Number initial,
...
*/
    ...
    public CustomTextField(Number min, Number max, Number initial,
            boolean rightJustify, NumberFormat numberFormat, String acceptedChars) {
        super(Math.max(min.toString().length(), max.toString().length()));
	...
	public CustomTextField(Integer min, Integer max, boolean rightJustify, String acceptedChars) {
	       super(Math.max(min.toString().length(), max.toString().length()));
	        this.acceptedChars = acceptedChars;
	        setNumberFormat(numberFormat);
	        if (min.getClass().equals(max.getClass())) {
	...
	public CustomTextField(Double min, Double max, boolean rightJustify,
			NumberFormat numberFormat, String acceptedChars) {
        super(Math.max(min.toString().length(), max.toString().length()));
        this.acceptedChars = acceptedChars;
        setNumberFormat(numberFormat);
        if (min.getClass().equals(max.getClass())) {
...
*/
    ...
    class ADocument extends PlainDocument {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -5608175362786162480L;
		Number currentVal;
        Number max;
        Number min;
        ...
        public Number parse(String proposedResult) throws NumberFormatException {
            ...
            if ((d.doubleValue() >= min.doubleValue()) &&
            	...
            	JOptionPane.showMessageDialog(MasterController.getGUIComponent(),"Input Error");
