...
public class PCeNRegistration_ErrorTableView extends PCeNTableView {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8735264180333013353L;
	 ...
	 */
	public PCeNRegistration_ErrorTableView(PCeNTableModel model, int rowHeight, PCeNTableModelConnector connector) {
