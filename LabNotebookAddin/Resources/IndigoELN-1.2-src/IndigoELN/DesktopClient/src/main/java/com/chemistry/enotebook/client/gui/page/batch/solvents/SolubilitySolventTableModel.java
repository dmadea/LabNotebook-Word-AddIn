...
public class SolubilitySolventTableModel extends AbstractTableModel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4108715895618395962L;
	...
	public void resetModelData() {
		try {
			for (int i = 0; i < getSolubilitySolventList().size(); i++) {
				BatchSolubilitySolventModel solubilitySolventVO = (BatchSolubilitySolventModel) getSolubilitySolventList()
						.get(i);
	 ...
	 */
	public void setSolventqualitativeList(List<RegQualitativeCache> solventqualitativeList) {
