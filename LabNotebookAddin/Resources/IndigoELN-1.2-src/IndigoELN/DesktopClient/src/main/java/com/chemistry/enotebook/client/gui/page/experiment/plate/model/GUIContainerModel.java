...
import com.chemistry.enotebook.client.gui.page.experiment.plate.view.GUIContainer;

public class GUIContainerModel 
{
    private GUIContainer view_;
    
    public void setView(GUIContainer view)
    {
        view_ = view;
    }
