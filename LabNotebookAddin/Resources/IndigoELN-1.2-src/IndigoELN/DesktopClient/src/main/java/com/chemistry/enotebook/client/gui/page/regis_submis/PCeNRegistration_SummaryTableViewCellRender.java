...
public class PCeNRegistration_SummaryTableViewCellRender implements TableCellRenderer {
	...
	public PCeNRegistration_SummaryTableViewCellRender() {
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row,
		...
		if (value instanceof MolString) {
			 ...
			 */
		} else if (value instanceof ProductPlate) {
			ProductPlate productPlate = (ProductPlate)value;
			JTextField plateBarCodeField = new JTextField();
