...
public class NotebookInsert extends SqlUpdate {
	public NotebookInsert(DataSource dsource, String sqlInsert) {
		...
		this.declareParameter(new SqlParameter(Types.LONGVARCHAR)); // XML_METADATA(XML_TYPE)
	}
}
