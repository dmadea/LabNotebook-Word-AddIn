...
//Previously extends BatchSqlUpdate
public class MonomerBatchUpdate extends SqlUpdate {
	private static final Log log = LogFactory.getLog(MonomerBatchUpdate.class);

	public MonomerBatchUpdate(DataSource ds) {
