...
{
	static final long serialVersionUID = -1135826434876874937L;
	...
	public ScreenInfoRequest() 
	{
		this(null, null, null);
	}
	
	// Must have screenProtocolID and one of these (scientistCode or scientistUserID) 
	public ScreenInfoRequest(String screenProtocolID, String scientistCode, String scientistUserID)
	{
