...
public class ExperimentNotFoundException extends Exception {
	static final long serialVersionUID = 3010406617659179242L;
	...
	public ExperimentNotFoundException(Exception e) {
		super(e);
	}

	public ExperimentNotFoundException(String msg, Exception e) {
		super(msg, e);
	}
}