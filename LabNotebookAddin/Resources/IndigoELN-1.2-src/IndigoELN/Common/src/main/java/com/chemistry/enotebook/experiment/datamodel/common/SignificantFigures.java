...
public class SignificantFigures extends Number {
	...
	/**
	 * Adjust the number of significant figures such that the leas significant digit is at the given place. This method may add
	 * significant zeros to the end of this number, or remove significant digits from this number.
	 * <p>
	 * If all significant digits are removed from this number by truncating to the least significant place, a zero will be created
	 * with significant figures from the least to most significant places.
	 * <p>
	 * This method has no effect if this number is not a number or infinity.
	 * 
	 * @param leastPlace
	 *            the desired place of the least significant digit or Integer.MIN_VALUE to ignore.
	 * @param mostPlace
	 *            the desired place of the most significant digit or Integer.MIN_VALUE to ignore.
	 * @return this number
	 * 
	 * @since ostermillerutils 1.00.00
	 */
